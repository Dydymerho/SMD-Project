...
public class SyllabusService {
    ...
    public Syllabus createSyllabus(Syllabus newSyllabus) {
        ...
        if (mysqlRepo.existsBySubjectCode(newSyllabus.getSubjectCode())) {
            throw new RuntimeException("Trùng mã môn: " + newSyllabus.getSubjectCode());
        }
    ...
    public Syllabus getSyllabusById(Long id) {
        ...
        Syllabus fromDb = mysqlRepo.findById(id).orElseThrow(() -> new RuntimeException("Không tìm thấy!"));
